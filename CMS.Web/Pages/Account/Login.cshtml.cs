...
namespace CMS.Web.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger,ApplicationDbContext applicationDbContext)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var currentuser = _applicationDbContext.Users.SingleOrDefault(m => m.UserName.Equals(Input.Name));
